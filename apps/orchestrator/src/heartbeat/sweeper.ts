...
import { withTransaction, nowIso, query, exec } from '@api/db/index.js';
import { findStaleAgents, setAgentOffline } from '@api/db/queries/agents.js';
import { insertEvent } from '@api/db/queries/events.js';
import type { Agent } from '@contracts/types.js';
