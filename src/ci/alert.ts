...
import { getCompetitor } from '../db/queries/competitors.js';
import { pendingHighCriticalChanges, insertAlert, updateAlertStatus } from '../db/queries/ci.js';
import { insertEvent } from '../db/queries/events.js';
import type { CompetitorChangeRow } from '../shared/types.js';
