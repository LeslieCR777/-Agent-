...
export function demoAgentOutput(stage: CiStage, _context: unknown): string {
  switch (stage) {
    ...
    case 'compare': {
      const competitorOnly = Boolean((_context as { competitorOnly?: boolean } | null)?.competitorOnly);
      return JSON.stringify(competitorOnly ? {
        left_competitor: '竞品 1',
        right_competitor: '竞品 2',
        dimensions: [
          { dimension: 'Product Features', left_score: 7, right_score: 7, notes: 'demo 数据：两款竞品功能接近' },
          { dimension: 'Pricing & Value', left_score: 8, right_score: 6, notes: 'demo 数据：竞品 1 的价格价值更高' },
          { dimension: 'User Experience', left_score: 7, right_score: 7, notes: 'demo 数据：两款竞品体验接近' },
          { dimension: 'Market Share & Momentum', left_score: 6, right_score: 8, notes: 'demo 数据：竞品 2 增长更快' },
          { dimension: 'Customer Sentiment', left_score: 7, right_score: 6, notes: 'demo 数据：竞品 1 口碑略优' },
          { dimension: 'Technology & Innovation', left_score: 7, right_score: 8, notes: 'demo 数据：竞品 2 技术创新领先' },
          { dimension: 'Ecosystem & Integrations', left_score: 6, right_score: 7, notes: 'demo 数据：竞品 2 生态略广' },
          { dimension: 'Support & Documentation', left_score: 8, right_score: 7, notes: 'demo 数据：竞品 1 支持更完善' },
        ],
        overall_assessment: 'demo 数据：两款竞品各有优势，竞品 1 在价格与支持上领先，竞品 2 在增长与技术上领先。',
      } : {
        dimensions: [
          ...
          { dimension: 'User Experience', our_score: 7, competitor_score: 7, notes: 'demo 数据：双方体验接近' },
          { dimension: 'Market Share & Momentum', our_score: 6, competitor_score: 8, notes: 'demo 数据：竞品增长更快' },
          { dimension: 'Customer Sentiment', our_score: 7, competitor_score: 6, notes: 'demo 数据：我方口碑略优' },
          { dimension: 'Technology & Innovation', our_score: 7, competitor_score: 8, notes: 'demo 数据：竞品 AI 领先' },
          { dimension: 'Ecosystem & Integrations', our_score: 6, competitor_score: 7, notes: 'demo 数据：竞品生态略广' },
          { dimension: 'Support & Documentation', our_score: 8, competitor_score: 7, notes: 'demo 数据：我方支持更完善' },
        ],
